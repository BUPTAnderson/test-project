...
//            TProtocolFactory tprotocol = new TJSONProtocol.Factory();
    ...
    public class AsynCallback
            implements AsyncMethodCallback<HelloWorldService.AsyncClient.sayHello_call>
    {
    ...
    {
        HelloWorldAsyncClient client = new HelloWorldAsyncClient();
