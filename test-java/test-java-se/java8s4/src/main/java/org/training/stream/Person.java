...
public class Person {
    ...
    public static List<Person> persons() {
        ...
        Person p2 = new Person(2, "李四", 5000, LocalDate.of(1967, 12, 2), Gender.FEMALE);
        Person p3 = new Person(3, "王五", 7000, LocalDate.of(1990, 4, 17), Gender.MALE);
        Person p4 = new Person(4, "赵六", 6500, LocalDate.of(1967, 3, 9), Gender.MALE);
        Person p5 = new Person(5, "钱七", 5200, LocalDate.of(1988, 10, 12), Gender.FEMALE);
